...
import br.com.danielxavier.alugames.modelo.Jogo
...
fun main() {
    ...
    do {
        ...
        resultado.onSuccess {
            ...
            if (opcao.equals("s", true)){
                println("Insira a descrição persinalizada para o jogo:")
        ...
        println("Deseha buscar um novo jogo? S/N")
    ...
    if (opcao.equals("s", true)){
        println(gamer.jogosBuscados)
        println("\nDigite o título do jogo que deseja excluir:")
        val posicao = leitura.nextInt()
        gamer.jogosBuscados.removeAt(posicao)
    }

    println("Jogos após exclusão:")
    println(gamer.jogosBuscados)
